...
function lotterySimulation({ chosenNumbers, verboseMode = true }) {
  ...
  // Retornando 1 se acertou na quadra, 0 caso contrário
  if (hits === 4) {
    print(verboseMode, "Parabéns! Você acertou na quadra!");
    return 1;
  } else {
    print(verboseMode, "Infelizmente você não acertou na quadra.");
    return 0;
  }
}
